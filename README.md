...
🚀 BCA Student | Aspiring **Data Scientist & AI Researcher**  
...
1. 📨 **Spam SMS Classifier using NLP**  
   - GitHub Repo: [Link](https://github.com/sumitkumar1233edeedad/Spam-SMS-Classifier-using-NLP)  
...
2. 🩺 **Diabetes Prediction using Machine Learning**  
   - GitHub Repo: [Link](https://github.com/sumitkumar1233edeedad/-Diabetes-Prediction-using-Machine-Learning)  
   - 💻 Live Demo (Streamlit App): [Click Here](https://clinical-diabetes-predictor.streamlit.app/)  

3. 🏠 **House Price Prediction using Machine Learning**  
